const fs = require("fs")
const { benchmarkList, getActualImpactSetPath, getDetectedImpactSetResultsPath, getDetectedImpactSetPath, STATUS } = require('./evaluationConstants')
...
function computeTruePositives(filename) {
    ...
    fs.writeFileSync(getDetectedImpactSetResultsPath(filename), JSON.stringify(detectedImpactSets));
