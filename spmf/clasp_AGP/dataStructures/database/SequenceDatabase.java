package spmf.clasp_AGP.dataStructures.database;
...
import spmf.clasp_AGP.dataStructures.Itemset;
import spmf.clasp_AGP.dataStructures.Sequence;
...
public class SequenceDatabase {
    ...
    public void addSequence(String[] integers) {
        /**
         * @TODO @sadjad should ignore sequences not containing our item-set for the item constraint. 
         * Also, for the remainig sequences, should keep locations of our item-set items.
         */
