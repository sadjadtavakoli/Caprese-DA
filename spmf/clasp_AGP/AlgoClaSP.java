...
public class AlgoClaSP {
     ...
     */
    public AlgoClaSP(double minSupAbsolute, AbstractionCreator abstractionCreator, boolean findClosedPatterns,
    ...
    protected void claSP(SequenceDatabase database, long minSupAbsolute, boolean keepPatterns, boolean verbose,
        ...
        if (verbose) {
            // System.out.println("ClaSP: The algorithm takes " + (mainMethodEnd -
            // mainMethodStart) / 1000 + " seconds and finds " + numberOfFrequentPatterns +
            // " patterns");
            System.out.println("ClaSP: The algorithm takes " + (mainMethodEnd - mainMethodStart) + " ms and finds "
