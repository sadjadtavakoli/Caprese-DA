 ...
 */
const REPO_TEST_EXCLUDED_DIRS = projects[REPO_URL]['excluded_dirs'];

/**
 * The relative path of files that you want to be excluded from FP analysis
 */
 const FP_EXCLUDED_DIRS = projects[REPO_URL]['fp_excluded_dirs']
/**
...
const FP_PATH = __dirname + path.sep + "clasp";
...
const FP_COMMAND = "cd " + FP_PATH + " ; mvn exec:java -Dexec.mainClass='clasp_AGP.MainCMClaSP' -Dexec.args=";
