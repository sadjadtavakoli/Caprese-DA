...
RUN wget https://github.com/graalvm/graalvm-ce-builds/releases/download/vm-20.2.0/graalvm-ce-java11-linux-aarch64-20.2.0.tar.gz
RUN tar -xvzf graalvm-ce-java11-linux-aarch64-20.2.0.tar.gz
RUN rm -r graalvm-ce-java11-linux-aarch64-20.2.0.tar.gz
